...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-8 mt-auto border-t-2 border-white">
          ...
          <div className="mb-4">
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 border-2 border-white rounded-l bg-black text-white placeholder-gray-500 focus:outline-none focus:border-white"
              />
              <button className="px-4 py-2 bg-white text-black rounded-r hover:bg-gray-200 transition-colors font-semibold">
                Subscribe
              </button>
            </div>
          </div>
